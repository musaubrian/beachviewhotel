        ...
        <div class="row">
                ...
                <!-- Empty Cart -->
                    <div class="row border-top py-3 mt-3">
                        <div class="col-sm-12 text-center py-2">
                            ...
                            <p class="font-baloo font-size-16 text-black-50">Empty slip</p>
                        </div>
                    </div>
                <!-- .Empty Cart -->
            </div>
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    <h6 class="font-size-12 font-rale text-success py-3"><i class="fas fa-check"></i> Your booking our utmost priority.</h6>
